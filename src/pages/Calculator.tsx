...
export default function CalculatorApp() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900 font-sans selection:bg-zinc-200 pb-20">
      <Helmet>
        <title>World's First Online Grill Estimator | WoodenMax</title>
        <meta name="description" content="Design custom aluminium window grills, balcony safety grills, and iron grills online. Accurate estimates with rates, safety, and wastage for homeowners, architects, and builders." />
        <link rel="canonical" href="https://grills.woodenmax.in/" />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "WebApplication",
            "name": "WoodenMax Grill Calculator",
            "url": "https://grills.woodenmax.in/",
            "description": "World's first online grill estimator for homeowners, architects, project managers, purchase departments, and builders. Get accurate budgets with rates, safety, and wastages.",
      ...
      <header className="bg-zinc-900 text-white py-6 px-4 sm:px-8 shadow-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-zinc-400 text-sm mt-1 uppercase tracking-widest">World's 1st Online Grill Estimator</p>
          </div>
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-8 text-emerald-800 text-sm flex items-center gap-3">
          <Info className="w-5 h-5 shrink-0 text-emerald-600" />
          <p>
            <strong>For Homeowners, Architects, Project Managers & Builders:</strong> Use this tool to generate accurate project budgets, calculate material wastage, ensure safety standards, and place online orders instantly.
          </p>
        </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white p-5 rounded-2xl shadow-sm border border-zinc-200 flex flex-col h-[500px]">
              ...
              <div className="flex-1 bg-zinc-100/50 rounded-xl overflow-hidden flex items-center justify-center p-8 border border-zinc-200 relative">
                ...
                >
                  <defs>
                    <linearGradient id="metal-plain" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="#52525b" />
                      <stop offset="50%" stopColor="#27272a" />
                      <stop offset="100%" stopColor="#18181b" />
                    </linearGradient>
                    <linearGradient id="metal-texture" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="#3f3f46" />
                      <stop offset="30%" stopColor="#27272a" />
                      <stop offset="70%" stopColor="#3f3f46" />
                      <stop offset="100%" stopColor="#18181b" />
                    </linearGradient>
                    <linearGradient id="metal-wooden" x1="0%" y1="0%" x2="100%" y2="0%">
